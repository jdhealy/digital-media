...
formController = new (FormController = (function() {
  ...
  FormController.prototype.add_output = function() {
    ...
    return $('credits').popover({
      title: 'Credits:',
      content: "<h3>Programmed and designed by J.D. Healy</h3>\n<h3>Based off <a href='http://en.wikipedia.org/wiki/Straight_Outta_Compton_(song)'>works</a> by <a href='http://en.wikipedia.org/wiki/N.W.A'>Eric \"Eazy-E\" Wright, O'Shea \"Ice Cube\" Jackson, Lorenzo \"MC Ren\" Patterson</a></h3>",
      placement: 'top',
      html: true
    });
  };
